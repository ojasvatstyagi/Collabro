...
class ProfilePictureControllerTest {
        ...
        void uploadProfilePicture_WithValidImage_ShouldReturnUpdatedProfile() throws Exception {
                // Arrange
                when(fileStorageService.uploadProfilePicture(any(MultipartFile.class))).thenReturn(testProfileDto);
                ...
                mockMvc.perform(multipart("/api/profile/picture")
                                ...
                                .andExpect(jsonPath("$.profilePictureUrl").value("new/path.jpg")); // Match the DTO
                                                                                                   // value

                verify(fileStorageService).uploadProfilePicture(any(MultipartFile.class));
        }
        ...
        void deleteProfilePicture_WhenExists_ShouldDeleteAndReturnNoContent() throws Exception {
                ...
                verify(profileService).saveProfile(argThat(profile -> profile.getProfilePictureUrl() == null));
        }
