  ...
  return (
    <div className="flex h-screen w-64 flex-col border-r border-brand-dark/10 bg-white dark:border-brand-light/10 dark:bg-brand-dark/80">
      ...
      <div className="flex-1 overflow-y-auto p-4">
        <div className="mb-8">
          <div className="flex items-center gap-3 rounded-lg bg-brand-light/30 p-3 dark:bg-brand-dark">
      ...
      <div className="border-t border-brand-dark/10 p-4 dark:border-brand-light/10">
        <button className="flex w-full items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium text-brand-dark/60 transition-colors hover:bg-brand-light/50 hover:text-brand-dark dark:text-brand-light/60 dark:hover:bg-brand-dark/50 dark:hover:text-brand-light">
